...
async def clear_database():
    ...
    async for session in get_db():
        try:
            ...
            await session.execute(text("DELETE FROM user_challenges"))
            await session.execute(text("DELETE FROM challenges"))
            await session.execute(text("DELETE FROM date_night_pairings"))
            await session.execute(text("DELETE FROM image_searches"))
            await session.execute(text("DELETE FROM saved_restaurants"))
            await session.execute(text("DELETE FROM interaction_logs"))
            await session.execute(text("DELETE FROM twin_relationships"))
            await session.execute(text("DELETE FROM taste_dnas"))
